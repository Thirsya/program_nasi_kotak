...
<div id="content">
	...
	<table id="tabel-tampil">
		...
		<tr>
			...
			<td>
				<div class="tombol-opsi-container"><a target="_blank" href="pages/cetak_kartu-buku.php?id=<?php echo $r_tampil_anggota['idbuku'];?>" class="tombol">Cetak Kartu</a></div>
				<div class="tombol-opsi-container"><a href="index.php?p=buku-edit&id=<?php echo $r_tampil_anggota['idbuku'];?>" class="tombol">Edit</a></div>
				<div class="tombol-opsi-container"><a href="proses/buku-hapus.php?id=<?php echo $r_tampil_anggota['idbuku']; ?>" onclick = "return confirm ('Apakah Anda Yakin Akan Menghapus Data Ini?')" class="tombol">Hapus</a></div>
			</td>			
		</tr>		
		<?php $nomor++; } 
		}
