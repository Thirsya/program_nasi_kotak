...
<div id="content">
	...
	<a target="_blank" href="pages/cetak-transaksi.php"><img src="print.png" height="50px" height="50px"></a>
	...
	<table id="tabel-tampil">
		...
		//$sql="SELECT * FROM tbtransaksi ORDER BY idanggota DESC";
		...
		<tr>
			...
			<td>
				<div class="tombol-opsi-container"><a target="_blank" href="pages/cetak_kartu-transaksi.php?id=<?php echo $r_tampil_anggota['idtransaksi'];?>" class="tombol">Cetak Kartu</a></div>
				<div class="tombol-opsi-container"><a href="index.php?p=transaksi-edit&id=<?php echo $r_tampil_anggota['idtransaksi'];?>" class="tombol">Edit</a></div>
				<div class="tombol-opsi-container"><a href="proses/transaksi-hapus.php?id=<?php echo $r_tampil_anggota['idtransaksi']; ?>" onclick = "return confirm ('Apakah Anda Yakin Akan Menghapus Data Ini?')" class="tombol">Hapus</a></div>
			</td>			
		</tr>		
		<?php $nomor++; } 
		}
