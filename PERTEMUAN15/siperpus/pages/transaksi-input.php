...
<div id="content">
	<form action="proses/transaksi-input-proses.php" method="GET" enctype="multipart/form-data">
	...
	<table id="tabel-input">
		...
		<tr>
			...
			<td class="isian-formulir"><input type="text" name="tglkembali" class="isian-formulir isian-formulir-border"></td>
		</tr>
		<tr>
