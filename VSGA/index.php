<?php
	...
	function hitung_tagihan_awal($harga, $jumlah){ 
		return $tagihanAwal = $harga * $jumlah;

		// Fungsi ini akan mengembalikan nilai tagihanAwal denga mengkalikan harga dengan jumlah
	}
...
<html>
	...
	<div class="container border">
		...
		<img src="Gambar/logo.png" alt="Logo Restoran" width="200" height="200">
			...
			<div class="row">
				...
				<div class="col-lg-2">
					...
					<?php
						...
						foreach($cabang as $cabangResto){
							echo "<option value='$cabangResto'>$cabangResto</option>";
						}
					?>	
					</select>
				</div>
